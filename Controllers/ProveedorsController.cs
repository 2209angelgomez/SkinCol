...
namespace SkinCol.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProveedorID,Nombre,NIT,Direccion,Telefono,Correo")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProveedorID,Nombre,NIT,Direccion,Telefono,Correo")] Proveedor proveedor)
        {
